...
router.get("/soso/api/routes/storeZoneInRectangle", async (req: Request, res: Response) => {
  ...
  const api_url = "http://apis.data.go.kr/B553077/api/open/sdsc2/storeZoneInRectangle";
